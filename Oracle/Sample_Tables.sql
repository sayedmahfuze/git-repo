...
alter table PRODUCTS drop constraint SYS_C0011774 ;
alter table PRODUCTS drop constraint SYS_C0011775;
alter table products drop constraint PRODUCTS_PRD_ID_PK;
alter table products drop constraint PRODUCTS_PRD_ID_PK;

select * from USER_CONSTRAINTS where r_constraint_name = 'PRODUCTS_PRD_ID_PK' is not null;
